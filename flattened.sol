...
// File contracts/CustomCoin.sol

// Original license: SPDX_License_Identifier: UNLICENSED
pragma solidity ^0.8.28;


contract CustomCoin is ERC20, Ownable {
    constructor() ERC20("Wrapped USDC", "wUSDC") Ownable(msg.sender) {}

    // Hàm mint token, chỉ owner được gọi
    function mint(address to, uint256 amount) external onlyOwner {
        _mint(to, amount);
    }

    // Hàm burn token, chỉ owner được gọi
